/*global history */
sap.ui.define([
	"bookshop/bookshop/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"bookshop/bookshop/model/formatter",
	"sap/m/MessageBox",
	"bookshop/bookshop/model/grouper",
	"bookshop/bookshop/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("bookshop.bookshop.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("bookshop.bookshop.view.ViewSettingsDialog", this);
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							BookId: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("BookId"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				BookId: encodeURIComponent(oItem.getBindingContext().getProperty("BookId"))
			}, bReplace);
		},
