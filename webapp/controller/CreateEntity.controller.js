sap.ui.define([
	...
	return BaseController.extend("bookshop.bookshop.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("BooksSet", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("BooksSet", oData);
