sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("bookshop/bookshop/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#BookshopCRUDOData-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#BookshopCRUDOData-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("bookshop.bookshop.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["bookshop/bookshop/localService/mockserver"], function (mockserver) {
